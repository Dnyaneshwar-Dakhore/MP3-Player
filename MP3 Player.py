...
class MP:
    def __init__(self, win):
        ...
        load_button = Button(win, text='Add', width=10, font=('Times', 20),bg="DodgerBlue2",fg="white", command=self.load)
        load_button.place(x=150, y=40, anchor='center')

        play_button = Button(win, textvariable=self.play_restart, width=10, font=('Times', 20),bg="DodgerBlue2",fg="white", command=self.play)
        play_button.place(x=150, y=80, anchor='center')

        pause_button = Button(win, textvariable=self.pause_resume, width=10, font=('Times', 20),bg="DodgerBlue2",fg="white", command=self.pause)
        pause_button.place(x=150, y=120, anchor='center')

        stop_button = Button(win, text='Stop', width=10, font=('Times', 20),bg="DodgerBlue",fg="white", command=self.stop)
